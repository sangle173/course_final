                    ...
                    <form method="post" class="row">
                        <div class="input-box col-lg-6">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="name" placeholder="Họ và tên">
                        ...
                        <div class="input-box col-lg-6">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="email" name="email" placeholder="Địa chỉ email">
                        ...
                        <div class="input-box col-lg-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form--control pl-3" name="message" placeholder="Viết bình luận ..." rows="5"></textarea>
                            </div>
                        </div><!-- end input-box -->
