                ...
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card bg-gray p-4 rounded">
                        <h3 class="fs-16 font-weight-semi-bold">Curated for the <a href="for-business.html"
                                                                                   class="text-color hover-underline">Aduca
                        ...
                        <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                            ...
                            <div class="curriculum-duration fs-15">
                                <span class="curriculum-total__text mr-2"><strong
                                        class="text-black font-weight-semi-bold">Total:</strong> {{ count($lecture) }} lectures</span>
                                ...
                                <span>
                                   ...
                                   {{ $lect->lecture_title }}
                                                                ...
                                                                <video width="300" height="200" controls>
                                                                    <source src="{{ $lect->url }}" type="video/mp4">
                                                                </video>
                                                            </div>
                                                        </li>
                                                    @endforeach
                        ...
                        <div class="instructor-wrap">
                            <div class="media media-card">
                                ...
                                <div class="media-body">
                                    ...
                                    <span
                                        class="d-block lh-18 pt-2 pb-3">Joined {{ Carbon\Carbon::parse($course->user->created_at)->diffForHumans()  }}</span>
                                    ...
                                    @if (count($percentages) > 0)
                                        @foreach ($percentages as $ratingInfo)
                                            ...
                                            <div class="review-bars d-flex align-items-center mb-2">
                                                ...
                                                <div
                                                    class="review-bars__percent">{{ number_format($ratingInfo['percent'], 2) }}
                                                    %
                                                </div>
                                            </div><!-- end review-bars -->
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                            class="la la-bolt mr-2 text-color"></i>Quizzes</span> 26
                                </li>
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                            class="la la-eye mr-2 text-color"></i>Preview Lessons</span> 4
                                </li>
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                            class="la la-users mr-2 text-color"></i>Students</span> 30,506
                                </li>
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                            class="la la-certificate mr-2 text-color"></i>Certificate</span> {{ $course->certificate }}
                                </li>
                            </ul>
                        </div>
                    </div><!-- end card -->
            ...
            <div class="col-lg-9">
                <div class="cta-content-wrap py-4 d-flex flex-wrap align-items-center">
                    <svg class="flex-shrink-0 mr-4" width="70" viewBox="0 -48 496 496"
                        ...
                        <path
                            d="m472 0h-448c-13.230469 0-24 10.769531-24 24v352c0 13.230469 10.769531 24 24 24h448c13.230469 0 24-10.769531 24-24v-352c0-13.230469-10.769531-24-24-24zm8 376c0 4.414062-3.59375 8-8 8h-448c-4.40625 0-8-3.585938-8-8v-352c0-4.40625 3.59375-8 8-8h448c4.40625 0 8 3.59375 8 8zm0 0"></path>
                        ...
                        <path
                            d="m32 364.945312 73.886719-36.945312-73.886719-36.945312zm16-48 22.113281 11.054688-22.113281 11.054688zm0 0"></path>
