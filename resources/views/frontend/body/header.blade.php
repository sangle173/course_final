        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                                                        <a href="{{ url('/') }}" class="logo"><img src="{{ asset('frontend/images/logo.png') }}" width="300px" height="70px" alt="logo"></a>
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="course-list-left-sidebar.html">list left sidebar <span class="ribbon ribbon-blue-bg">New</span></a>
                    </li>
                    <li><a href="course-list-right-sidebar.html">list right sidebar <span class="ribbon ribbon-blue-bg">New</span></a>
                    </li>
